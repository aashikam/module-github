...
string testOrganizationName = system:getEnv("ORG_NAME");
string testRepositoryName = system:getEnv("REPO_NAME");
string testResourcePath = system:getEnv("RESOURCE_PATH");
string testIssueAssignee = system:getEnv("ASSIGNEE");
